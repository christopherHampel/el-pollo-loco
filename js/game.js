    ...
    startScreenBackground.innerHTML = `
        <div class="start-screen">
            <div class="button-start-steering">
                ...
                <button class="start-button" onclick="showImprint()">Legal Notice</button>
            </div>
        </div>`
}
...
function showSettings() {
    ...
    <div id="settings" class="settings">
        <div class="container-for-close-button" onclick="closeSettings()">
...
dieser Website ist:</p> <p>Christopher Hampel<br />
